...
//Small versions of Rocks
	...
	class SmallPlatinum_rock: Thing
	{
		scope=2;
	...
	class Wheat_StalkTest: GroundCrop
	{
		model="Models\LandResources\wheatstalk.p3d";
		icon="Models\LandResources\wheatstalkicon.paa";
		displayname="Wheat Stalk";
